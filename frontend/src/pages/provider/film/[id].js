...
const FilmDetail = ({ films }) => {
    ...
    const inputsValidation = updateTitle === '' ||
        updateDescription === '' ||
        updateCategorie === '' ||
        updateStatus === '' ||
        updateDuration === '' ||
        ...
        updateRating === '' ||
        updateAward === '' ||
        dataProtagonists[0] === "" || dataGnre[0] === "" || dataBackdrop_path === "" || dataPoster_path === "" || isCheckSelectedGenre.length < 1
                ...
                <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
                    <div className='bg-white overflow-hidden shadow-sm sm:rounded-lg'>
                        <div className='p-6 bg-white border-b border-gray-200'>
                            Editar pelicula, se recomienda llenar
                            todos los datos
                        </div>
                    </div>
