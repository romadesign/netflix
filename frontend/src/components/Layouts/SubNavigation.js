...
const SubNavigation = ({ title }) => {
    ...
    const urlSeries = router.pathname === '/series' || router.pathname === '/series/genre/[id]'
    const urlFilms = router.pathname === '/peliculas' || router.pathname === '/peliculas/genre/[id]'
    ...
    return (
        <>
            <div
                ...
                <div
                    className={`${!isScrolled ? styles.subnavbar_text : styles.subnavbarContentGenre
                        }`}>
                    {title}
